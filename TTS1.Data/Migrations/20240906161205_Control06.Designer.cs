...
namespace TTS.Data.Migrations
{
    ...
    [Migration("20240906161205_Control06")]
    partial class Control06
    {
            ...
            modelBuilder.Entity("TTS.Entity.Entities.CevreselIzleme.Field", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1047),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1053),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("TTS.Entity.Entities.CevreselIzleme.Sensor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BatteryLevel = 0.0,
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6164),
                        ...
                        new
                        {
                            ...
                            BatteryLevel = 0.0,
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6170),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.CevreselIzleme.SensorData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7a7e1174-587c-4f03-b693-8e9b76827589"),
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5507),
                            IsDeleted = false,
                            SensorId = new Guid("fde368ee-2228-43ee-b3cc-1ea8932843a5"),
                            Timestamp = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5510),
                            Unit = "°C",
                            Value = "Fotokapan kayıtlarına göre bir canlı kayıtlara girmiştir."
                        },
                        new
                        {
                            Id = new Guid("f78ea244-ac8e-4e50-9fa8-31b99a319384"),
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5512),
                            IsDeleted = false,
                            SensorId = new Guid("0123f278-ff34-44d0-af18-f7f5882ed35a"),
                            Timestamp = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5514),
                            Unit = "pH",
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Identity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2d577418-3b65-41d4-b645-6e1cecb4c91a",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "bf8538dc-5000-4fa0-b622-1fc6e1036aaa",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "abc8db04-eb40-4ac6-b836-1133d376be3d",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bce0b2bf-78a8-464f-a722-a612ce2079ac",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJTsSID7+DIlP00CoiUoGBxwxcfbSiE/wxko+k9mzcpHvRMLpbqGkZueNARM5y25TQ==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "11cad848-e435-4fd2-8ab0-fa8aa6980726",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b898ace2-fd5b-4351-8301-61e264bcd6f3",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOD4bI5kCBCZY5rrRKwJQbiOBMQk4lQMTBle9SYKVEQ6KzXROI//2R9pVZ/CSlkKCw==",
                            PhoneNumber = "1234566480",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "67a9fcdb-f58e-4990-96b1-162332ba162b",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Identity.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1266),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1269),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Lojistik.Package", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1349),
                            IsDeleted = false,
                            Number = 1,
                            PackagingDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1352),
                            Type = "Kutu"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1354),
                            IsDeleted = false,
                            Number = 2,
                            PackagingDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1355),
                            Type = "Torba"
                        });
                });
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Lojistik.Transport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6378),
                            ...
                            Timestamp = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6383),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6386),
                            ...
                            Timestamp = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6388),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Lojistik.Vehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 411, DateTimeKind.Local).AddTicks(8869),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 411, DateTimeKind.Local).AddTicks(8878),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Market.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1436),
                            IsDeleted = false,
                            Name = "Fındık",
                            Price = 130m,
                            Unit = "Kg"
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(1440),
                            IsDeleted = false,
                            Name = "Kestane",
                            Price = 250m,
                            Unit = "Tane"
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Market.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5411),
                            IsDeleted = false,
                            ProductCount = 1m,
                            ProductId = new Guid("971f7086-05e6-4c7a-92a8-216c924affdb"),
                            SaleDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5416),
                            UserId = new Guid("b497f1b4-3299-4cb9-94af-e3a1a6c7ac8e")
                        },
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5418),
                            IsDeleted = false,
                            ProductCount = 2m,
                            ProductId = new Guid("64ef8e12-5802-4295-b902-ab9e3f9f03bd"),
                            SaleDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(5421),
                            UserId = new Guid("989afd35-55a6-40a2-92b7-725a9b0e8822")
                        });
                });
            ...
            modelBuilder.Entity("TTS.Entity.Entities.UretimIslemleri.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(844),
                            IsDeleted = false,
                            Location = "Düzce",
                            Name = "TMO"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(867),
                            IsDeleted = false,
                            Location = "Ankara",
            ...
            modelBuilder.Entity("TTS.Entity.Entities.UretimIslemleri.Stage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6264),
                            IsDeleted = false,
                            Name = "Kurutmaya bırakıldı",
                            Parameter = "Kurutma",
                            ProductId = new Guid("971f7086-05e6-4c7a-92a8-216c924affdb"),
                            Timestamp = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6267)
                        },
                        new
                        {
                            Id = new Guid("30a9512b-ed73-4338-988c-5b43bc810de0"),
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6288),
                            IsDeleted = false,
                            Name = "Ayıklandı",
                            Parameter = "Ayıklama",
                            ProductId = new Guid("64ef8e12-5802-4295-b902-ab9e3f9f03bd"),
                            Timestamp = new DateTime(2024, 9, 6, 19, 12, 4, 408, DateTimeKind.Local).AddTicks(6289)
                        });
                });
