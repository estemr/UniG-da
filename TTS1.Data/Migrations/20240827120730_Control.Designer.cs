...
namespace TTS.Data.Migrations
{
    ...
    [Migration("20240827120730_Control")]
            ...
            modelBuilder.Entity("TTS.Entity.Entities.CevreselIzleme.Field", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(3730),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(3736),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("TTS.Entity.Entities.CevreselIzleme.Sensor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BatteryLevel = 0.0,
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8481),
                        ...
                        new
                        {
                            ...
                            BatteryLevel = 0.0,
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8488),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.CevreselIzleme.SensorData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("57da7760-752b-47ca-9489-fbecd5174c8b"),
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7807),
                            IsDeleted = false,
                            SensorId = new Guid("fde368ee-2228-43ee-b3cc-1ea8932843a5"),
                            Timestamp = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7810),
                            Unit = "°C",
                            Value = "Fotokapan kayıtlarına göre bir canlı kayıtlara girmiştir."
                        },
                        new
                        {
                            Id = new Guid("86b55bbd-9b69-44f3-81e1-95391808b77c"),
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7833),
                            IsDeleted = false,
                            SensorId = new Guid("0123f278-ff34-44d0-af18-f7f5882ed35a"),
                            Timestamp = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7834),
                            Unit = "pH",
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Identity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0658193e-88f6-4be5-9460-6801951176db",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2268cd37-9bff-4059-9c2d-082e671a1685",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b0f181fc-3567-446d-9b7d-472bae77d405",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ae23073a-4ca0-4f9f-bddf-09f07e14743e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJsjR4ZJSUVfpBhMVsiMf1AQO6vbKJDPJHBZdGLd7glGvT7W+0wTVyflECrts+uzpA==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "8611e1f1-3af9-428c-b0b9-cb4345ee0e81",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5ff9c168-df4e-474f-bf63-d7758cbc08df",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDySsitafAtsS7+ViqM/bMUgQ/SY+2RSUdSUXuYnTdwTdKCtjK1yQsncDliK1zhH3g==",
                            PhoneNumber = "1234566480",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8c6e86f6-6308-4685-b75f-6f040546d42e",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Identity.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(3846),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(3848),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Lojistik.Package", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(4032),
                            IsDeleted = false,
                            Number = 1,
                            PackagingDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(4036),
                            Type = "Kutu"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(4047),
                            IsDeleted = false,
                            Number = 2,
                            PackagingDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(4048),
                            Type = "Torba"
                        });
                });
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Lojistik.Transport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8662),
                            ...
                            Timestamp = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8668),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8671),
                            ...
                            Timestamp = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8676),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Lojistik.Vehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 985, DateTimeKind.Local).AddTicks(4455),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 985, DateTimeKind.Local).AddTicks(4467),
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Market.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(4129),
                            IsDeleted = false,
                            Name = "Fındık",
                            Price = 130m,
                            Unit = "Kg"
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(4134),
                            IsDeleted = false,
                            Name = "Kestane",
                            Price = 250m,
                            Unit = "Tane"
            ...
            modelBuilder.Entity("TTS.Entity.Entities.Market.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7716),
                            IsDeleted = false,
                            ProductCount = 1m,
                            ProductId = new Guid("971f7086-05e6-4c7a-92a8-216c924affdb"),
                            SaleDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7720),
                            UserId = new Guid("b497f1b4-3299-4cb9-94af-e3a1a6c7ac8e")
                        },
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7723),
                            IsDeleted = false,
                            ProductCount = 2m,
                            ProductId = new Guid("64ef8e12-5802-4295-b902-ab9e3f9f03bd"),
                            SaleDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(7726),
                            UserId = new Guid("989afd35-55a6-40a2-92b7-725a9b0e8822")
                        });
                });
            ...
            modelBuilder.Entity("TTS.Entity.Entities.UretimIslemleri.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(3522),
                            IsDeleted = false,
                            Location = "Düzce",
                            Name = "TMO"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(3543),
                            IsDeleted = false,
                            Location = "Ankara",
            ...
            modelBuilder.Entity("TTS.Entity.Entities.UretimIslemleri.Stage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8578),
                            ...
                            Timestamp = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8581)
                        },
                        new
                        {
                            Id = new Guid("30a9512b-ed73-4338-988c-5b43bc810de0"),
                            CreatedBy = "Undefined",
                            CreatedDate = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8584),
                            ExpirationDate = new DateTime(2024, 8, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Name = "Ayıklandı",
                            Parameter = "Ayıklama",
                            ...
                            Timestamp = new DateTime(2024, 8, 27, 15, 7, 29, 981, DateTimeKind.Local).AddTicks(8586)
                        });
                });
